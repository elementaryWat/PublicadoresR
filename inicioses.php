				...
				success: function(data)
					{
						if (data=="pub" || data=="adm")
						{
							...
							setTimeout("redireccionar('"+data+"')","3000");
						} else if (data=="no")
						{
							mensaje.css("display","block");
...
<div class="login-form">
    ...
    <div class="form-group log-status">
     ...
     <div class="form-group log-status">
       <input type="password" class="form-control" placeholder="Contraseña" id="Passwod" name="pass">
       <i class="fa fa-lock"></i>
     </div>
      <a class="link" href="#" onclick="mostrarsolicitud()">¿Has olvidado tu contraseña?</a>
