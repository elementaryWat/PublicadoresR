...
<script type="text/javascript">
	...
	{
		var criterio=$("input[name=filtro]:checked").val();
		alert('El criterio es ',criterio);
		if (busqueda=="")
		{
			var rangoa="todo";
		}
	...
	<div id="page" class="container"><div class="inner_copy"></div>
		...
		<div id="sidebar">
        	<div id="filtrop">
            	<h2>Ver solo</h2>
            	<div>
                <p><label><input type="radio" name="filtro"/>Todos</label></p>
                <p><label><input type="radio" name="filtro"/>Ancianos</label></p>
                <p><label><input type="radio" name="filtro"/>Siervos ministeriales</label></p>
                <p><label><input type="radio" name="filtro"/>Precursores regulares</label></p></div>
            </div>
		</div>
