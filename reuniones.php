						...
						success: function(data)
							{
								...
								$("#acordeon1").accordion({ heightStyle: "content",active: false,collapsible: true});
								$("#acordeon2").accordion({ heightStyle: "content",active: false,collapsible: true});
							}
					}
				);
	}
					...
					success: function(data)
						{
							...
							$("#modificaras").attr("value","Modificar asistencia de "+Nombrereu);
