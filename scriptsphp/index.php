...
<script type="text/javascript">
	$(document).ready(function(e) {
        botonprueba=$("#prueba");
		obtenerpublicadores("");
		$("#datosuser").accordion({ heightStyle: "content",active: false,collapsible: true});;
    });
		...
		$.ajax(
				{
					...
					type:"GET",
					cache:false,
					url:"scriptsphp/obtenerpublicadores.php?rango="+rangoa+"&busqueda="+busqueda,
...
<div id="wrapper">
	...
	<div id="page" class="container"><div class="inner_copy"></div>
		...
		<div id="sidebar">
        	<div id="datosuser">
            <h2>Ver datos de mi cuenta</h2>
                <div>
                    <ul>
                    	<li><p>Nombre: <? echo $Nombre;?></p></li>
                        <li><p>Apellido: <? echo $Apellido;?></p></li>
                        <li><p>Grupo: <? echo $Grupo;?></p></li>
                        <li><p id="miuser">Nombre de usuario: <? echo $usuario;?></p></li>
                        <li><p id="mipasw">Contraseña: <? echo $passus;?></p></li>
                        ...
                        <li><h4><a href="scriptsphp/cerrarses.php">Cerrar sesion</a></h4></li>
                    </ul>
                </div>
            </div>
		</div>
